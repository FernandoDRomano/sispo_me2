...
use App\Models\Base\LiquidacionClienteBase;

class LiquidacionCliente extends LiquidacionClienteBase
{
...
//    ];
     ...
     * @var array
     */
    protected $fillable = ['usuario_id', 'cliente_id', 'departamento_id',  'factura', 'periodo_desde', 'periodo_hasta', 'observaciones', 'estado_id'];
