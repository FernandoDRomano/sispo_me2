...
use App\Models\Base\ComprobanteGeneradoBase;
use App\Models\Traits\EstadosTrait;

class ComprobanteGenerado extends ComprobanteGeneradoBase
{
    use EstadosTrait;

    const ESTADO_USADO = 0;
    const ESTADO_DISPONIBLE = 1;
    const ESTADO_IMPRESO = 2;
     ...
     * @var array
     */
    protected $fillable = ['talonario_id', 'numero', 'estado'];
