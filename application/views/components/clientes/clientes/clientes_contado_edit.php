<?php
    echo form_open(base_url('clientes/clientes/edit/'.$result->id.'/null/clientes_contado'), array('class'=>""));
        ...
        <div class="ibox-content">
            <div class="control-group">
                <div class="controls">
                    ...
                    <a class="btn btn-danger" href="<?php echo base_url().$this->uri->segment(1).'/'.$this->uri->segment(2).'/clientes_contado'; ?>"><i class="fa fa-arrow-circle-left"></i> Volver</a>
                </div>
            </div>
        </div>
    </div>
