<div class="col-xs-12">
    <div class="ibox-content">
        <div class="text-right">            
            <a href="<?php echo base_url().'clientes/clientes/add/clientes_contado_add' ?>" class="btn btn-success"><i class="fa fa-plus"></i> Nuevo cliente</a>
        </div>
    </div>
    <div class="ibox-content">
        <form action="<?php echo base_url() ?>clientes/clientes/filtro/clientes_contado_list" method="post" id="form-filtro">
            <div class="row">
                <div class="col-xs-3">
                    ...
                    <div class="form-group">
                        ...
                        <select id="tipo" name="tipo" class="form-control filtro-group">
                            ...
                            <?php foreach ($tipos as $f) {?>
                                <option value="<?php echo $f->id ?>" <?php echo $f->id == 1?"selected":"disabled='disabled'"?> ><?php echo $f->nombre ?></option>
                            <?php } ?>
                        </select>
                    </div>
                </div>
            ...
            <tbody>
              <?php foreach ($results as $result) { ?>
                  <tr>
                    ...
                    <td>
                      <div class="btn-group">
                        <a href="<?php echo base_url().'clientes/clientes/edit/'.$result->id.'/null/clientes_contado_edit' ?>" class="btn btn-success"><i class="fa fa-edit"></i></a>
