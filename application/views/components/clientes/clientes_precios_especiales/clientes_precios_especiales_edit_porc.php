<div class="col-xs-12">
    <div class="ibox-content">
        ...
        <form action="<?php echo base_url() ?>clientes/clientes_precios_especiales/guardarPreciosEspecialesPorcentajes" method="post" id="form-filtro">
            <div class="row">
                <input type="hidden" id="cliente_id" name="cliente_id" value="<?php if ($cliente_id) {
                                                                                    echo $cliente_id;
                                                                                } ?>" />
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <span class="input-group-addon">
                                <input type="radio" name="actualizar_por" value="imp">
                            </span>
                            <input id="importe" name="importe" type="number" class="form-control" step="0.01" min="0" required disabled />
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xs-3">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <span class="input-group-addon">
                                <input type="radio" name="actualizar_por" value="por" checked required>
                            </span>
                            <input id="porcentaje" name="porcentaje" type="number" class="form-control" step="0.01" min="0" required />
                        </div>
                    </div>
                </div>
            </div>
...
<script type="text/javascript">
    $(document).ready(function() {
        $("#form-filtro").validate({
            rules: {
                grupo: {
                    require_from_group: [1, ".filtro-group"]
                },
                servicio: {
                    require_from_group: [1, ".filtro-group"]
                },
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        //Handle radios
        $('input[type=radio][name=actualizar_por]').change(function() {
            if (this.value == 'por') {
