        ...
        <div class="row">
            <div class="col-12">
                <div class="form-group">
                    <h2>Actualizando Forma de buscar el sub esquema</h2>
                </div>
            </div>
        </div>
        <div class="row">
         ...
         <div class="row">
            ...
            <div class="col-xs-6">
                <div class="form-group">
                    ...
                    <select onchange="cargarLocalidadesProvincia(event)" name="provincia_origen" id="provincia_origen" class="form-control" style="width: 100%;">
                        <option value="0">Seleccione</option>
                    </select>
                </div>
            </div>
            <div class="col-xs-6">
                <div class="form-group">
                    ...
                    <select onchange="validarLocalidad(event, 1)" disabled name="localidad_origen" id="localidad_origen" class="form-control" style="width: 100%;">
                        <option value="0">Seleccione</option>
                    </select>
                </div>
            </div>
...
<form method='post' action='<?php echo base_url('piezasN/piezas_paquetes/getPaqueteriaXClienteNuevo')?>' id='getListPaqueteriaXCliente'>
...
<script type="text/javascript">
  ...
  function cargarProvincias(){
    ...
    if(provincias){
        ...
        document.getElementById('provincia_origen').insertAdjacentHTML('beforeend', html)
    }

  }

  async function cargarLocalidadesProvincia(event){
    const provincia = event.target.value
    document.getElementById('localidad_origen').innerHTML = ""
    document.getElementById('localidad_origen').disabled = true
    ...
    try {
        ...
        if(data){
            ...
            document.getElementById('localidad_origen').insertAdjacentHTML('beforeend', html)
            document.getElementById('localidad_origen').disabled = false
        }
    } catch (error) {
        console.log(error)
    }
