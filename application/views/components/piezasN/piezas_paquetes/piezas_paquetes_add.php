    ...
    <div class="ibox-content">
        ...
        <div id="piezas-paquetes">
            ...
            <div class="row" id="piezas-all" style="display:none;">
                <div class="col-xs-12" id="titleDestinatario" style="display: none;">
                    <h3 class="tituloFormulario">Destinatario</h3>
                </div>
                <div class="col-xs-8" id="groupDestinatario" style="display: none;">
                    <div class="form-group">
                        <label for="destinatario">Nombre del Destinatario: <span class="required">*</span></label>
                        <input id="destinatario" name="destinatario" type="text" class="form-control" placeholder="Destinatario" autocomplete="off" />
                    </div>
                </div>
                <div class="col-xs-4" id="groupBarcodeExterno" style="display: none;">
                    <div class="form-group">
                        <label for="barcode_externo">Codigo Barras Externo: <span class="required">*</span></label>
                ...
                <div class="col-xs-12" id="titleDomicilioDestino" style="display: none;">
                    <h3 class="tituloFormulario">Direcci&oacute;n de Destino</h3>
                </div>
                <div class="col-xs-12" id="groupPais" style="display: none;">
                    <div class="form-group">
                        <label for="pais_destino">Pa&iacute;s: <span class="required">*</span></label>
                        <select name="pais_destino" id="pais_destino" style="width: 100%;" disabled>
                        </select>
                    </div>
                </div>
                <div class="col-xs-4" id="groupProvincia" style="display: none;">
                    <div class="form-group">
                        <label for="provincia_destino">Provincia: <span class="required">*</span></label>
                        <select onchange="cargarLocalidadesPorProvincia(event)" name="provincia_destino" id="provincia_destino" style="width: 100%;">
                            <option value="">Seleccione una Opci&oacute;n</option>
                        </select>
                    </div>
                </div>
                <div class="col-xs-4" id="groupLocalidad" style="display: none;">
                    <div class="form-group">
                ...
                <div class="col-xs-4" id="groupCodigoPostal" style="display: none;">
                    <div class="form-group">
                        <label for="codigo_postal">CP Destino: <span class="required">*</span></label>
                        <input id="codigo_postal" name="codigo_postal" type="text" class="form-control" placeholder="CP" autocomplete="off" />
                    </div>
                </div>
                <div class="col-xs-9" id="groupDomicilio" style="display: none;">
                    <div class="form-group">
                ...
                <div class="col-xs-3" id="groupNumero" style="display: none;">
                    <div class="form-group">
                        <label for="numero">Altura: <span class="required">*</span></label>
                        <input id="numero" name="numero" type="text" class="form-control" placeholder="N&uacute;mero" autocomplete="off" />
                    </div>
                </div>
                <div class="col-xs-6" id="groupPiso" style="display: none;">
                    <div class="form-group">
                        <label for="piso">Piso: </label>
                        <input  id="piso" name="piso" type="text" class="form-control" placeholder="Piso" />
                    </div>
                </div>
                <div class="col-xs-6" id="groupDepartamento" style="display: none;">
                    <div class="form-group">
                        <label for="departamento">Departamento/Oficina: </label>
                        <input  id="departamento" name="departamento" type="text" class="form-control" placeholder="Departamento" />
                    </div>
                </div>
                <div class="col-xs-6" id="groupEsquina1" style="display: none;">
                    <div class="form-group">
                        <label for="esquina_1">Esquina: </label>
                        <input  id="esquina_1" name="esquina_1" type="text" class="form-control" placeholder="Esquina" />
                    </div>
                </div>
                <div class="col-xs-6" id="groupEsquina2" style="display: none;">
                    <div class="form-group">
                        <label for="esquina_2">Esquina 2: </label>
                        <input  id="esquina_2" name="esquina_2" type="text" class="form-control" placeholder="Esquina" />
                    </div>
                </div>
                <div class="col-xs-12" id="groupObservaciones" style="display: none;">
                    <div class="form-group">
                ...
                <div class="col-xs-12" id="groupGeocodificar" style="display: none;">
                    <div class="form-group" style="display: flex; justify-content: end;">
                        <a onclick="geocodificar(event)" href="#" class="btn btn-info btn-sm"><i class="fa fa-globe"></i> Geocodificar</a>
                    </div>
                </div>
                
                <input type="hidden" name="geocodificada" id="geocodificada" value="0">
                ...
                <div class="col-xs-12" id="titleDatosVarios" style="display: none;">
                    <h3 class="tituloFormulario">Datos extras</h3>
                </div>
...
<script type="text/javascript">
  ...
  `;
    ...
    */
    const titleDestinatario = document.getElementById('titleDestinatario')
    ...
    const titleDomicilioDestino = document.getElementById('titleDomicilioDestino')
    const groupPais = document.getElementById('groupPais')
    const groupProvincia = document.getElementById('groupProvincia')
    const groupLocalidad = document.getElementById('groupLocalidad')
    ...
    const groupEsquina1 = document.getElementById('groupEsquina1')
    const groupEsquina2 = document.getElementById('groupEsquina2')
    const groupPiso = document.getElementById('groupPiso')
    const groupDepartamento = document.getElementById('groupDepartamento')
    const groupObservaciones = document.getElementById('groupObservaciones')
    const groupGeocodificar = document.getElementById('groupGeocodificar')

    const titleDatosVarios = document.getElementById('titleDatosVarios')
    ...
    //let clientes = <?= isset($clientes) ? json_encode($clientes) : ""?>;
    ...
    async function geocodificar(event){
        event.preventDefault()

        loading.css('display', 'block');

        const pais = $('#pais_destino').select2('data')[0].text
        const provincia = $('#provincia_destino').select2('data')[0].text 
        const localidad = $('#localidad').select2('data')[0].text 
        const CP = document.getElementById('codigo_postal').value
        const calle = document.getElementById('domicilio').value
        const altura = document.getElementById('numero').value

        const dominio = document.domain;
        const url = `//${dominio}/piezasN/Piezas_paquetes/geocodificar`;
            ...
            if(data){
                ...
                switch (data.condicion) {
                    case 1:
                        ...
                        document.getElementById('geocodificada').value = 1
                        ...
                        alert("Geocodificacion exitosa")
                        break;
                    
                    case 2:
                        limpiarGeocodificacion()
                        alert("Error: Debes corregir la direccion")
                        break;

                    case 3:
                        limpiarGeocodificacion()
                        alert("Error: Faltan datos para geocodificar, revise por favor.")
                        break;
    ...
    async function validarCampos(event) {
        ...
        if ($("#tarifario").val() != "warehouse" && $("#tarifario").val() != "gestionFlota") {
            ...
            if ($("#descripcion_paquete").val() == "") {
                alert("El paquete debe tener la DESCRIPCION");
            ...
            if($('#pais_destino').val() == "" || $('#pais_destino').val() == "0"){
                alert("La direccion del paquete debe tener el PAÍS");
                $("#pais_destino").focus();
                return;
            }

            if ($("#provincia_destino").val() == "" || $("#provincia_destino").val() == "0") {
                alert("La direccion del paquete debe tener la PROVINCIA");
                $("#provincia_destino").focus();
                return;
            }

            if ($("#localidad").val() == "" || $("#localidad").val() == "0") {
                alert("La direccion del paquete debe tener la LOCALIDAD");
                $("#localidad").focus();
                return;
            }

            if ($("#domicilio").val() == "") {
                alert("La direccion del paquete debe tener la CALLE");
                $("#domicilio").focus();
                return;
            }

            if ($("#numero").val() == "") {
                alert("La direccion del paquete debe tener la ALTURA");
                $("#numero").focus();
                return;
            }

            if ($("#codigo_postal").val() == "") {
                alert("La direccion del paquete debe tener el CODIGO POSTAL");
                $("#codigo_postal").focus();
                return;
            }

            if($('#geocodificada').val() == "" || $('#geocodificada').val() == "0"){
                alert("La direccion del paquete debe ser GEOCODIFICADA");
                return;
            }
    ...
    function limpiarGeocodificacion(){
        document.getElementById('latitud').value = ""
        document.getElementById('longitud').value = ""
        document.getElementById('geocodificada').value = 0
    }
    ...
    async function crearCamposDinamicos(event) {
        ...
        titleDomicilioDestino.style.display = "none"
        titleDatosVarios.style.display = "none"
        titleDestinatario.style.display = "none"
        groupPais.style.display = "none"
        groupLocalidad.style.display = "none"
        groupProvincia.style.display = "none"
        groupNumero.style.display = "none"
        groupEsquina1.style.display = "none"
        groupEsquina2.style.display = "none"
        groupPiso.style.display = "none"
        groupDepartamento.style.display = "none"
        groupObservaciones.style.display = "none"
        groupGeocodificar.style.display = "none"
    ...
    function crearVistaKilos(html) {
        ...
        groupPais.style.display = "block"
        titleDestinatario.style.display = "block"
        titleDomicilioDestino.style.display = "block"
        titleDatosVarios.style.display = "block"
        groupLocalidad.style.display = "block"
        groupProvincia.style.display = "block"
        groupNumero.style.display = "block"
        groupEsquina1.style.display = "block"
        groupEsquina2.style.display = "block"
        groupPiso.style.display = "block"
        groupDepartamento.style.display = "block"
        groupObservaciones.style.display = "block"
        groupGeocodificar.style.display = "block"
    ...
    function mostrarPanel() {
        document.getElementById("wrapper-paqueteria").style.display = "block"
    ...
    function ocultarPanel() {
        document.getElementById("wrapper-paqueteria").style.display = "none"
    ...
    async function enviar() {
        ...
        const datos = {
            ...
            domicilio: $("#domicilio").val() + ' ' + $("#numero").val(),
            codigo_postal_destino: $("#codigo_postal").val(),
            piso: $("#piso").val(),
            departamento_oficina: $("#departamento").val(),
            esquina_1: $("#esquina_1").val(),
            esquina_2: $("#esquina_2").val(),
            observaciones_destino: $("#observaciones").val(),
            ...
            geocodificada: $("#geocodificada").val()
        }
