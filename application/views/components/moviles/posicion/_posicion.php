...
<div class="col-xs-12">
    <div class="ibox-content">
        ...
        <div>
        <h4 class="stat-cards-info__num ml-4">Datos de posiciones</h4>
           <?php 
...
<script>
    ...
    async function buscar_datos_mapa(origen_llamado,cartero){
        ...
        try {            
            const dominio = document.domain;
            const url = `//${dominio}/moviles/posicion/carteros_posiciones`;
            ...
            const resp = await fetch(url, {
                ...
                body: JSON.stringify({parametros:parametros, pais:pais})
            })
