...
<?php
    ...
    Elementos::CrearTitulo("Medicion de Carteros");
    echo('<div class="col-md-12">');
    ...
    Elementos::CrearTabladashboard("IngresosPorCarteros","12","","display:block",true,10,"display: none","text-align: right;",true,"","text-align: left;","white-space: unset;",2.1);
    echo('</div>');
    echo('<div class="container Grafica-1" id="GraficaIngresosPorCarteros" style="display: none;overflow: hidden;"></div>');
    echo('</div>');
    echo('<hr class="size2 hideline">');
...
<script>
	...
	function Buscar(){
		...
		var Config = JSON.parse(`
		{
			"Elemento":"DivIngresosPorCarteros",
			...
			"DataTable":false,
			"Sispo":true,
			"Ajax":"` + URLJS + `/Administrador/AjaxIngresosCarterosPorSucursalListado"
