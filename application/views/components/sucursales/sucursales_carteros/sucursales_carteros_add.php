...
<div class="col-xs-12">
    <div class="ibox-content">
        ...
        <div class="row">
            ...
            <div class="col-xs-4">
                <div class="form-group">
                    ...
                    <input id="telefono" name="telefono" type="number" class="form-control tags" placeholder="Telefono" />
                </div>
            </div>
            ...
            <div class="col-xs-6">
                <div class="form-group">
                    ...
                    <select disabled id="sucursal_id" name="sucursal_id" class="form-control">
                        <option value="0">Seleccione una opci&oacute;n</option>
                    </select>
                </div>
            </div>
            ...
            <div class="col-xs-8">
                <div class="form-group">
                    ...
                    <input id="dni_cuit_cuil" name="dni_cuit_cuil" type="number" class="form-control" placeholder="DNI/CUIT/CUIL/otro" />
                </div>
            </div>
            <div class="col-xs-6">
                <div class="form-group">
                    <label for="ingresos_brutos">Ingresos Brutos:</label>
                    <input id="ingresos_brutos" name="ingresos_brutos" type="text" class="form-control" placeholder="Ingresos Brutos" />
                </div>
            </div>
            <div class="col-xs-6">
                <div class="form-group">
                    <label for="inicio_actividades">Inicio de Actividades (MM/AAAA):</label>
                    <input id="inicio_actividades" name="inicio_actividades" type="text" class="form-control" placeholder="MM/AAAA" />
                </div>
            </div>
            ...
            <div class="col-xs-3">
                <div class="form-group">
                    ...
                    <input id="altura" name="altura" type="number" class="form-control" placeholder="Altura" />
                </div>
            </div>
            <div class="col-xs-3">
                <div class="form-group">
            ...
            <div class="col-xs-6">
                <div class="form-group">
                    ...
                    <input id="afip_fecha_vencimiento" name="afip_fecha_vencimiento" type="date" class="form-control" />
                </div>
            </div>
            ...
            <div class="col-xs-6">
                <div class="form-group">
                    ...
                    <input type="file" name="afip_imagen" id="afip_imagen" class="form-control" accept="image/png,image/jpeg,image/jpg">
                </div>
            </div>
            ...
            <div class="col-xs-6">
                <div class="form-group">
                    ...
                    <input id="carnet_conductor_fecha_vencimiento" name="carnet_conductor_fecha_vencimiento" type="date" class="form-control" />
                </div>
            </div>
            ...
            <div class="col-xs-6">
                <div class="form-group">
                    ...
                    <input type="file" name="carnet_conductor_imagen" id="carnet_conductor_imagen" class="form-control" accept="image/png,image/jpeg,image/jpg">
                </div>
            </div>
        ...
        <div class="control-group">
            <div class="controls">
                <?php echo form_button(array('type'  => 'submit', 'onclick' => 'validar()', 'value' => 'Guardar', 'name'  => 'btnSubmit', 'class' => 'btn btn-success'), "<i class='fa fa-floppy-o'></i> Guardar"); ?>
