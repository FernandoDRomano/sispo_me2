<div class="col-xs-12">
	...
	?>
                        ...
                        <div class="form-group">
                            ...
                            <input  id="user_id" name="user_id" type="text" class="form-control" placeholder="User_id" />
                        </div>

                        <div class="form-group">
                            <label for="consulta">Consulta</label>
                            <textarea  id="consulta" name="consulta" class="summernote form-control" placeholder="Consulta"></textarea>
                        </div>
