<div class="col-xs-12">
	...
	<form class="form_liquidacion_ddis_acreditaciones_edit" id="form_liquidacion_ddis_acreditaciones_edit" 
                name="form_liquidacion_ddis_acreditaciones_edit" action="<?php echo base_url('liquidaciones/liquidaciones_ddis_acreditaciones/edit')?>" method="post">
                    <?php   echo form_hidden('enviar_form','1');?>
                    <?php   echo form_hidden('acreditacion_id_p',$result->acreditacion_id);?>    
                        <div class="row">
                            <div class="col-xs-12">
