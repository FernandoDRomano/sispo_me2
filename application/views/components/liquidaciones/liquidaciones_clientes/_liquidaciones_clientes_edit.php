                        ...
                        <?php   $suma_total = 0;
                                ...
                                foreach ($detalles as $detalle) {?>
                                    ...
                                    <tr id="resultados" class="nueva"><input type="hidden" name="fila_<?=$contador?>" value="<?=$contador?>"/>
                                        ...
                                        <td style="text-align:right;<?php echo $estilo?>"><?=$detalle->precio?></td></td><input type="hidden" id="precio_<?=$contador?>" name="precio_<?=$contador?>" value="<?=$detalle->precio?>"/>
                                        <td style="text-align:right;<?php echo $estilo?>"><?=number_format($importe,3);?></td></td><input type="hidden" id="importe_<?=$contador?>" name="importe_<?=$contador?>" value="<?=number_format((int)$detalle->cantidad * (float)$detalle->precio,3);?>"/>
