        ...
        <div class="panel-body">
            <div class="tab-content">
              <div id="tab-1" class="tab-pane active">
                <form class="form_liquidacion_carteros_add" id="form_liquidacion_carteros_add" name="form_liquidacion_ddis_add" action="<?php echo base_url('liquidaciones/liquidaciones_ddis/add')?>" method="post" enctype="multipart/form-data">
                        ...
                        <tbody id="body-grilla">
                            <?php foreach ($results as $result) { ?>
                                <tr id="resultados" class="nueva">
                                    ...
                                    <!--<td style="text-align: right">$ <?=$result->valor_entrega?></td>-->
                                    <!--<td style="text-align: right">$ <?=$result->valor_especial_entrega?></td>-->
<!--                                    <td>
                                        <div class="btn-group">
