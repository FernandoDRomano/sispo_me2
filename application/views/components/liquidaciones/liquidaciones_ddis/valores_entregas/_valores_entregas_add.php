                        ...
                        <div class="row">
                            <div class="col-xs-6">
                                <div class="form-group">
                                    ...
                                    <input id="zona" name="zona" type="text" class="form-control filtro-group" placeholder="Zona" autocomplete="off" value="<?php echo $zona?>"/>
                            ...
                            <div class="col-xs-3">
                                <div class="form-group">
                                    ...
                                    <input id="valor" name="valor" type="text" class="form-control" placeholder="0.000" value=""  required autocomplete="off" />
                                </div>
                            </div>
                        </div>
                        <hr/>
...
//                data: {},
//                cache: false,
//                success: function(data){alert(JSON.stringify(data));window.location.reload();}
//            });
        }
      });
    }    
