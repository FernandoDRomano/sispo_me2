        ...
        <div class="row">
          <div class="col-xs-6">
            <div class="form-group">
                ...
                <input id="cliente" name="cliente" type="text" class="form-control" placeholder="Escriba el nombre del cliente" autocomplete="off" required value="<?=$cliente?>" />
            </div>
          ...
          <div class="col-xs-6">
            <div class="form-group">
                ...
                <input class="form-control" id="paqueteria_tipo" name="paqueteria_tipo" type="text" value="<?=$paqueteria_tipo?>" readonly="true" />
            </div>
            <div id="div_acuses"></div>
            <div id="div_etiquetas"></div>  
          </div>
