<div class="col-xs-12">
  <div class="ibox-content">
    <form class="form-comprobante" id="form-comprobante" action="<?php echo base_url('piezas/novedades/grabar_novedades_piezas_simples')?>" method="post" enctype="multipart/form-data">
      <div id="errores"></div>
        ...
        <div class="col-xs-2">
         ...
         <div class="col-xs-2">
             <div class="form-group">
                ...
                <input  id="cantidad_original" name="cantidad_original" type="hidden" value="" />
                <input  id="tipo_id" name="tipo_id" type="hidden" value="" />
