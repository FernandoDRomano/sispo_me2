...
//                alert(numero.barcode+"    "+codigo_externo);
                if (numero.barcode == codigo_externo){
                   codigos_iguales.push('<strong>C.I:</strong> '+numero.comprobante_nro+' <strong>C¨®digo:</strong> '+numero.barcode+' <strong>ID:</strong> '+numero.id+'<br/>');
                   item_id = numero.id;
                   //alert(codigos_iguales+ '<strong>C.I:</strong> '+numero.comprobante_nro+' <strong>C¨®digo:</strong> '+numero.barcode+' <strong>ID:</strong> '+numero.id+'<br/>');
                }
            });
