...
flash.despachos = {
    ...
    {   
        console.log(id, comprobante_ingreso_id);
        ...
        $.ajax({
            ...
            success: function(data){
                ...
                if(data.error){
                    alert(data.error);
                    $('#codigo_barra').removeAttr('readonly');
                    $('#codigo_barra').val('');
                    $('#loadding').hide();
                ...
                if(data.despacho_verificado_parcial)
                {
                    $(".btn-recibir").removeAttr("disabled");
                    $('[data-field=despacho_estado]').html('Verificado');
                    $('#codigo_barra').removeAttr('readonly');
                    $('.btn-verificar-'+ data.pieza_id).attr('disabled', 'disabled');
                    $('#codigo_barra').val('');
                    $('#loadding').hide();
                    var table = $('#results').DataTable();
                    volverTabla(table);
