			...
			<div class="col-xs-12">
				<div class="col-xs-6">
					<div class="form-group">
					  ...
					  <input id="email_dest" class="form-control" placeholder="email destinatario"></input>
					</div>
				</div>
				<div class="col-xs-6">
					<div class="form-group">
					  <label for="celular_dest">Celular</label>
					  <input id="celular_dest" class="form-control" placeholder="celular destinatario"></input>
					</div>
				</div>
			</div>
        </div>
...
<!--            Como la consulta tiene un count cuando no tiene resultados muestra un registro con nulls
                ...
                <?php //if ($comprobante_servicio->servicio_nombre != ""):?>
                    <tr <?php echo $class;?>>
                      <td class="barcodear"><?=isset($comprobante_servicio->barcode)?$comprobante_servicio->barcode:""?></td>
                      <td class="barcodear"><?=isset($comprobante_servicio->barcode_externo)?$comprobante_servicio->barcode_externo:""?></td>
                      <td>
                        <b>Servicio: </b> <?=isset($comprobante_servicio->servicio_nombre)?$comprobante_servicio->servicio_nombre:""?><br>
                        <b>Estado: </b> <?=isset($comprobante_servicio->pieza_estado_nombre)?$comprobante_servicio->pieza_estado_nombre:""?><br>
                        <b>Tipo: </b> <?=isset($comprobante_servicio->acuse)&&isset($comprobante_servicio->nombre)&&isset($comprobante_servicio->pieza_tipo_nombre)&&($comprobante_servicio->acuse == 1)?"Normal"." - ".$comprobante_servicio->pieza_tipo_nombre:isset($comprobante_servicio->pieza_tipo_nombre)?"Simple"." - ".$comprobante_servicio->pieza_tipo_nombre:""?><br>
                        <?php if(isset($comprobante_servicio->acuse) && $comprobante_servicio->acuse == 1): ?>
                          <b>Codigo barras externo: </b> <?=isset($comprobante_servicio->barcode_externo)?$comprobante_servicio->barcode_externo:""?><br>
                        <?php else: ?>
                          <b>Cantidad de piezas : </b><?=isset($comprobante_servicio->cantidad_piezas)?$comprobante_servicio->cantidad_piezas:"";?>
                        <?php endif; ?>
                      </td>
                      <td>
                        <?php if(isset($comprobante_servicio->acuse) && $comprobante_servicio->acuse == 1 || 
								isset($comprobante_servicio->acuse) &&($comprobante_servicio->acuse == 0 && $comprobante_servicio->destinatario != '')): ?>
                        ...
                        <?php endif; ?>
                        <b>Datos varios: </b> <?=isset($comprobante_servicio->datos_varios)?$comprobante_servicio->datos_varios:""?>
                         <?php if(isset($comprobante_servicio->servicio_id) && $comprobante_servicio->servicio_id == 2): //2=paqueteria ?>
                        <br><b style="text-decoration: underline">Paqueteria</b><br>
                            <b>Descripcion: </b> <?=isset($comprobante_servicio->descripcion_paquete)?$comprobante_servicio->descripcion_paquete:""?><br>
                            <b>Dimensiones: </b> <?=isset($comprobante_servicio->dimensiones)?$comprobante_servicio->dimensiones:""?><br>
                            <b>Peso: </b> <?=isset($comprobante_servicio->peso)?$comprobante_servicio->peso:""?><br>
                            <b>Bulto: </b> <?=isset($comprobante_servicio->bultos)?$comprobante_servicio->bultos:""?><br>
                          <?php endif; ?>
                      </td>
                      <td >
                            <?php if(isset($comprobante_servicio->servicio_id) && $comprobante_servicio->servicio_id == 2): //2=paqueteria ?>
