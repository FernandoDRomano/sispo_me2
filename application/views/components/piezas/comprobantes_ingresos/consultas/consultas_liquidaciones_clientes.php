<div class="col-xs-12">
    <div class="ibox-content">
        <form action="<?=base_url('piezas/comprobantes_ingresos/consulta_liquidaciones_clientes_filtro')?>" method="post" id="form-filtro">
            <div class="row">
                <div class="col-xs-3">
...
<form method='post' action='<?php echo base_url('piezas/comprobantes_ingresos/exportar_consulta_liquidaciones_clientes')?>' id='exportAExcel'>
