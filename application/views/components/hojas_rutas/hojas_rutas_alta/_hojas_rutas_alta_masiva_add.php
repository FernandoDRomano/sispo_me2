            ...
            $.ajax({
                        ...
                        success: function(data){
                            ...
                            if (data.mensaje){
                                ...
                                $('.agregar-piezas-hdr').hide(); 
                                var tabla = "<hr><p>Las siguientes piezas ya se encuentran en otras hojas de ruta</p><table  id='results' class='table table-striped table-hover table-condensed bootstrap-datatable table-bordered'>"+
                                                "<tr>"+
                                                    "<td>HDR</td>"+
                                                    "<td>Pieza</td>"+
                                                    "<td>Estado Pieza</td>"+
