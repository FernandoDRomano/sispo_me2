          ...
          <tr>
            ...
            <td>
                <div class="btn-group">
                    ...
                    <?php if($permisos_efectivos->delete==1) { ?><a onClick="eleminarUsuario('<?php echo base_url().'backend/auth/deleteUser/'.$result->id ?>')" href="#" class="btn btn-danger"><i class="fa fa-trash-o"></i></a><?php } ?>
                </div>
            </td>
          </tr>
          <?php } ?>
