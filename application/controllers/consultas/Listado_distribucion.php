...
class Listado_distribucion extends MY_Controller
{
    ...
    function consultas_distribucion_filtro(){
        ...
        $mayor_a = $this->input->post('mayor_a') != ""?$this->input->post('mayor_a'):0;
        $menor_a = $this->input->post('menor_a') != ""?$this->input->post('menor_a'):0;
        $results = $this->flash_md->getListadoDistribucionPendientesRendir($periodo_desde,$periodo_hasta,$sucursal_id,$mayor_a,$menor_a);
    ...
    public function exportar_consulta_distribucion(){
            ...
            $mayor_a = $this->input->post('excel_mayor_a') != ""?$this->input->post('excel_mayor_a'):0;
            $menor_a = $this->input->post('excel_menor_a') != ""?$this->input->post('excel_menor_a'):0;
            $dias = $this->input->post('excel_dias') != ""?$this->input->post('excel_dias'):false;
           
            $hojas_rutas = $this->flash_md->getListadoDistribucionPendientesRendir($periodo_desde,$periodo_hasta,$sucursal_id,$mayor_a,$menor_a);
