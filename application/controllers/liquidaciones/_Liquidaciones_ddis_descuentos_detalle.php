...
class Liquidaciones_ddis_descuentos_detalle extends CI_Controller {
...
//			'results' => $this->codegen_model->get('flash_liquidaciones_ddis_descuentos_detalle','*','')
//		);
//
//		$vista_externa = array(			
//			'title' => ucwords("Liquidaciones Descuentos"),
//			'contenido_main' => $this->load->view('components/liquidaciones/liquidaciones_ddis_descuentos_detalle/liquidaciones_ddis_descuentos_detalle_list', $vista_interna, true)
//		);		
//		
...
//					'user_id_create' => $this->input->post('user_id_create'),
//					'user_id_update' => $this->input->post('user_id_update')
//				);
//			$this->codegen_model->add('flash_liquidaciones_ddis_descuentos_detalle',$data);
//			redirect(base_url().'liquidaciones/liquidaciones_ddis_descuentos_detalle');
//		}		  
//   
//		$vista_interna = array(
//			'permisos_efectivos' => $this->permisos
...
//		$vista_externa = array(			
//			'title' => ucwords("Liquidaciones Descuentos"),
//			'contenido_main' => $this->load->view('components/liquidaciones/liquidaciones_ddis_descuentos_detalle/liquidaciones_ddis_descuentos_detalle_add', $vista_interna, true)
//		);		  
//   
//		$this->load->view('template/backend', $vista_externa);
//	}	
...
//                    echo base_url().'liquidaciones/liquidaciones_ddis_acreditaciones_detalle/edit/'.$id;die;
                    redirect(base_url().'liquidaciones/liquidaciones_ddis_descuentos_detalle/edit/'.$id);
		}

                $results = $this->getLiquidacionesDescuentosDetalles($id);
		$vista_interna = array(
                        'permisos_efectivos' => $this->permisos,
			'results' => $results,
                        'carteros' => $this->codegen_model->get('flash_sucursales_carteros','*',''),
                        'descuentos' => $this->codegen_model->get('flash_liquidaciones_ddis_descuentos','*',''),
                        'autorizadores' => $this->getDdisAutorizadores(),
			'result' => $this->codegen_model->row('flash_liquidaciones_ddis_descuentos_detalle','*','id = '.$id),
                        'liquidacion_ddi_id' => $id
		);
                
		$vista_externa = array(			
			'title' => ucwords("Liquidaiones Descuentios"),
			'contenido_main' => $this->load->view('components/liquidaciones/liquidaciones_ddis_descuentos_detalle/liquidaciones_ddis_descuentos_detalle_edit', $vista_interna, true)
		);		  
...
//		$vista_externa = array(			
//			'title' => ucwords("Liquidaciones Descuentos"),
//			'contenido_main' => $this->load->view('components/liquidaciones/liquidaciones_ddis_descuentos_detalle/liquidaciones_ddis_descuentos_detalle_view', $vista_interna, true)
//		);		  
//   
...
//	}
	...
	function json($id){
		$json = $this->codegen_model->row('flash_liquidaciones_ddis_descuentos_detalle','*','id = '.$id);
		if($json) echo json_encode($json);
		else echo json_encode(array('status' => 'none'));
	}

	function json_all(){
		$json = $this->codegen_model->get('flash_liquidaciones_ddis_descuentos_detalle','*','');
		if($json) echo json_encode($json);
		else echo json_encode(array('status' => 'none'));
	}
	
	function delete($id){
		$this->codegen_model->delete('flash_liquidaciones_ddis_descuentos_detalle','id',$id);             
	}
        ...
        function getLiquidacionesDescuentosDetalles($id = null, $acreditacion_id = null){
...
//echo $query;die;
    ...
    public function autorizarDescuentoDdi($liquidacion_ddi_id, $acreditacion_ddi_detalle_id){
            $user_row = $this->ion_auth->user()->row();
            
            $query = " UPDATE flash_liquidaciones_ddis_descuentos_detalle lad "
                    . "SET  "
...
//echo $query;die;
            ...
            redirect(base_url().'liquidaciones/liquidaciones_ddis_descuentos_detalle/edit/'.$liquidacion_ddi_id);
        }
        
}

/* End of file liquidaciones_ddis_descuentos_detalle.php */
/* Location: ./system/application/controllers/liquidaciones_ddis_descuentos_detalle.php */