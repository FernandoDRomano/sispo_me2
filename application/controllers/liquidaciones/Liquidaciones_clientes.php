    ...
    //                                        {$estado_liquidacion = 2; $comprobante_liquidacion_id = $liquidacion_cliente_id;} //0=Sin Liquidar, 1=En proceso, 2=Liquidado
		...
		$vista_interna = array(
			'permisos_efectivos' => $this->permisos,
                        ...
                        'sucursales' => $this->codegen_model->get('flash_sucursales','*',''),
                        'sucursal_id' => -1,//$this->codegen_model->get('flash_sucursales','*',''),
                        'periodo_desde' => "",
                        'periodo_hasta' => "",
                        'fecha_ci_desde' => "",
                        'fecha_ci_hasta' => "",
...
//                echo $this->db->last_query();die;
                ...
                foreach ($facturab as $value) {
                      ...
                      $html_cuerpo    .= '<tr>
                                            ...
                                            <td style="text-align:right;"><span style="float:left">$</span><span style="float:right">'.number_format ( $precio, 3).'</span></td>
                                            <td style="text-align:right;"><span style="float:left">$</span><span style="float:right">'.number_format($importe,3).'</span></td>
                                        </tr>';
                     }
                 ...
                 $html_total = '<tr>
                                               <td class=""></td>
                                                ...
                                                <td style="text-align:right"><span style="float:left">$</span><span style="float:right"><strong>'.number_format($suma_total,3).'</strong></span></td>
                                            </tr>
                                            ';
...
//                echo $this->db->last_query();die;
                ...
                foreach ($facturaa as $value) {
                      ...
                      $html_cuerpo    .= '<tr>
                                            ...
                                            <td>'.$value->servicio.'</td>
                                            <td style="text-align:right;">'.$value->cant_a_liquidar.'</td>
                                            <td style="text-align:right"><span style="float:left">$</span><span style="float:right;text-align:left">'.$precio.'</span></td>
                                            <td style="text-align:right"><span style="float:left">$</span><span style="float:right;text-align:left">'.number_format($importe,3).'</span></td>
                                        </tr>';
                     }
                 ...
                 $html_total = '<tr>
                                               <td class=""></td>
                                                ...
                                                <td class=""></td>
                                                <td class=""><strong>Sub-Total:</strong></td>
                                                <td style="text-align:right"><span style="float:left">$</span><span style="float:right;text-align:left"><strong>'.number_format($suma_total,3).'</strong></span></td>
                                            </tr>
                                            <tr>
                                                <td class=""></td>
                                                <td class=""></td>
                                                ...
                                                <td style="text-align:right"><span style="float:left">$</span><span style="float:right;text-align:left"><strong>'.number_format($iva_solo,3).'</strong></span></td>
                                            </tr>
                                            <tr>
                                                <td class=""></td>
                                                <td class=""></td>
                                                ...
                                                <td style="text-align:right"><span style="float:left">$</span><span style="float:right;text-align:left"><strong>'.number_format($total_iva,3).'</strong></span></td>
                                            </tr>';
                                 //$('#grilla').append(cabecera+body+total+cierre); 
