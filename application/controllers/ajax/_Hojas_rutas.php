...
//            echo $this->db->last_query();die;
        ...
        public function add_piezas_simples(){
            ...
            $sql = " INSERT  INTO flash_subpiezas (hoja_ruta_id, pieza_id, liquidacion_id, cantidad, pieza_estado_id) 
                    SELECT 
                            $hoja->id as hoja_ruta_id, p.id as pieza_id, 0, 1, ".Pieza::ESTADO_EN_DISTRIBUCION." 
                     FROM `flash_piezas` `p`
