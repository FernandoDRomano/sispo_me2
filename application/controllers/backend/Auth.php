        ...
        if ($this->form_validation->run() == true) {
            if ($this->ion_auth->username_check($this->input->post('identity'))) {
                ...
                if ($this->ion_auth->login($this->input->post('identity'), $this->input->post('password'), $remember) == TRUE) {
                    ...
                    {
                        $mensaje = '<div class="alert alert-block alert-danger fade in"><button data-dismiss="alert" class="close close-sm" type="button"><i class="fa fa-times"></i></button><strong>Error!</strong> Debes ingresar por la aplicación movil</div>';
                    ...
                    */
                    ...
                    /* Verificar vencimiento de la contraseña */                    
                    ...
                    if (is_null($usersClavesVencimientosModel)) {                        
                        ...
                        if ($fecha_vencimiento < $actual) {
                            ...
                            $mensaje = '<div class="alert alert-block alert-danger fade in"><button data-dismiss="alert" class="close close-sm" type="button"><i class="fa fa-times"></i></button><strong>Error!</strong> Su contraseña expiró. Por favor, pongase en contacto con el Administrador.</div>';
                            $this->session->set_flashdata('message', $mensaje);
                            ...
                            $mensaje = '<div class="alert alert-block alert-danger fade in"><button data-dismiss="alert" class="close close-sm" type="button"><i class="fa fa-times"></i></button><strong>Error!</strong> Debe cambiar su contraseña en ' . $interval->format('%R%a') . ' días.</div>';
                            $this->session->set_flashdata('message', $mensaje);
                        }
                    }                                      
                    /* END: Verificar vencimiento de la contraseña */                    
