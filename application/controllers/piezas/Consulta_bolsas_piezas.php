...
class Consulta_bolsas_piezas extends CI_Controller {
	...
	function index(){
            ...
            $vista_externa = array(			
                    ...
                    'contenido_main' => $this->load->view('components/piezas/piezas/consulta_bolsas_piezas', $vista_interna, true)
            );		
        ...
        if ($this->ion_auth->isAdmin())
            ...
            if ($periodo_hasta != "") {
             ...
             foreach ($sucursales_todas as $value ){
                 ...
                 if ( $sum_query_der == "") {$sum_query_der .= "sum((SELECT count(fpie.id)
