...
//
   ...
   function token(){
    ...
    function solicitud($barcode_externo,$domicilio,$codigo_postal,$localidad,$destinatario,$bulto,$dimensiones,$peso){
        ...
        echo "<script>console.log('" .'Token Verficaciè´—n: '.$token. "');</script>";
        ...
        //termina la funciè´—n de solicitud de mis envios
...
//                 echo($this->db->last_query());die;
        ...
        $data     = array(
            ...
            'descripcion' => 'Comprobante: ' . $comprobante_ingreso->numero . '. A√±adir Piezas_paquetes.',
            'origen'      => '',
            'destino'     => '',
        );
