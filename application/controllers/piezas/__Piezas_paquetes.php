...
//        echo $comprobante_ingreso->numero;die;
        ...
        redirect(base_url('piezas/piezas_paquetes/index/'));
    }
    ...
    public function crearComprobanteIngresoServicio($comprobante_ingreso){
        ...
        $comprobante_generado = ComprobanteGenerado::whereNumero($comprobante_ingreso->numero);
...
//        $vista_interna = array(
//            'permisos_efectivos' => $this->permisos,
//            'results'            => $this->flash_md->comprobantes_ingresos_fecha_sucursal($periodo_desde, $periodo_hasta, $sucursal),
...
//
//        $hojas_rutas = $this->flash_md->comprobantes_ingresos_fecha_sucursal($periodo_desde, $periodo_hasta, $sucursal);
//
...
//        $this->excel->getActiveSheet()->setCellValue("I1", 'Sucursal');
//        // set cells values
//        $this->load->library('simplehtmldom_1_5/simple_html_dom');
//        $i = 2;
...
//            $this->excel->getActiveSheet()->setCellValue("I$i", $value->sucursal);
//            $i++;
//        }
//
//        $this->excel->setActiveSheetIndex(0);
