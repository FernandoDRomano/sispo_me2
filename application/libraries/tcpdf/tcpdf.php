...
class TCPDF {
	 ...
	 * @protected
	 */
	protected $header_sucursal = '';
        
        /**
	 * Title to be printed on default page header.
	 * @protected
	 */
	protected $header_departamento = '';
        
        /**
	 * Title to be printed on default page header.
	 * @protected
	 */
	protected $header_liquidacion_nro = '';
        
        /**
	 * Title to be printed on default page header.
	 * @protected
	 */
	protected $header_cliente = '';
        
        /**
	 * Title to be printed on default page header.
	 * @protected
	 */
	protected $header_factura_nro = '';
        
        /**
	 * Title to be printed on default page header.
	 * @protected
	 */
	protected $header_periodo_desde = '';
        
        /**
	 * Title to be printed on default page header.
	 * @protected
	 */
	protected $header_periodo_hasta = '';
        /**
	 * Title to be printed on default page header.
	 * @protected
	 */
	protected $header_paqueteria = '';
	...
	protected $departamento = '';
        ...
        /**
	 * Document liquidacion_nro.
	 * @protected
	 */
	protected $liquidacion_nro = '';
	...
	protected $cliente = '';
        ...
        /**
	 * Document factura_nro.
	 * @protected
	 */
	protected $factura_nro = '';
        
        /**
	 * Document periodo_desde.
	 * @protected
	 */
	protected $periodo_desde = '';
        
        /**
	 * Document periodo_hasta.
	 * @protected
	 */
	protected $periodo_hasta = '';
	...
	public function SetTitle($title) {
        ...
        /**
	 * Defines the sucursal of the document.
	 * @param $sucursal (string) The title.
	 * @public
	 * @since 1.2
	 * @see SetAuthor(), SetCreator(), SetKeywords(), SetSubject()
	 */
	public function SetSucursal($sucursal) {
        ...
        /**
	 * Defines the departamento of the document.
	 * @param $departamento (string) The title.
	 * @public
	 * @since 1.2
	 * @see SetAuthor(), SetCreator(), SetKeywords(), SetSubject()
	 */
	public function SetDepartamento($departamento) {
        ...
        /**
	 * Defines the liquidacion_nro of the document.
	 * @param $liquidacion_nro (string) The title.
	 * @public
	 * @since 1.2
	 * @see SetAuthor(), SetCreator(), SetKeywords(), SetSubject()
	 */
	public function SetLiquidacionNro($liquidacion_nro) {
		$this->liquidacion_nro = $liquidacion_nro;
	}
        
        /**
	 * Defines the cliente of the document.
	 * @param $cliente (string) The title.
	 * @public
	 * @since 1.2
	 * @see SetAuthor(), SetCreator(), SetKeywords(), SetSubject()
	 */
	public function SetCliente($cliente) {
        ...
        /**
	 * Defines the factura_nro of the document.
	 * @param $factura_nro (string) The title.
	 * @public
	 * @since 1.2
	 * @see SetAuthor(), SetCreator(), SetKeywords(), SetSubject()
	 */
	public function SetFacturaNro($factura_nro) {
		$this->factura_nro = $factura_nro;
	}
        
        /**
	 * Defines the periodo_desde of the document.
	 * @param $periodo_desde (string) The title.
	 * @public
	 * @since 1.2
	 * @see SetAuthor(), SetCreator(), SetKeywords(), SetSubject()
	 */
	public function SetPeriodoDesde($periodo_desde) {
		$this->periodo_desde = $periodo_desde;
	}
        
        /**
	 * Defines the periodo_hasta of the document.
	 * @param $periodo_hasta (string) The title.
	 * @public
	 * @since 1.2
	 * @see SetAuthor(), SetCreator(), SetKeywords(), SetSubject()
	 */
	public function SetPeriodoHasta($periodo_hasta) {
		$this->periodo_hasta = $periodo_hasta;
	}

        /**
	 * Defines the departamento of the document.
	 * @param $paqueteria (string) The title.
	 * @public
	 * @since 1.2
	 * @see SetAuthor(), SetCreator(), SetKeywords(), SetSubject()
	 */
	 ...
	 * @param $lc (array) RGB array color for line.
         ...
         * @param $liquidacion_nro (string) sucursal
         * @param $cliente (string) sucursal
         * @param $factura_nro (string) sucursal
         * @param $periodo_desde (string) sucursal
         * @param $periodo_hasta (string) sucursal
         * @param $departamento (string) departamento
         * @param $paqueteria (string) paqueteria
	 * @public
	 */
	public function setHeaderData($ln='', $lw=0, $ht='', $hs='', $tc=array(0,0,0), $lc=array(0,0,0),
                                    $liquidacion_nro,$cliente,$factura_nro,$periodo_desde,$periodo_hasta,$sucursal,$departamento,$paqueteria) {
		$this->header_logo = $ln;
		...
		$this->header_line_color = $lc;
                $this->header_sucursal = $sucursal;
                $this->header_liquidacion_nro = $liquidacion_nro;
                $this->header_cliente = $cliente;
                $this->header_factura_nro = $factura_nro;
                $this->header_periodo_desde = $periodo_desde;
                $this->header_periodo_hasta = $periodo_hasta;
                $this->header_departamento = $departamento;
                $this->header_paqueteria = $paqueteria;
	}
