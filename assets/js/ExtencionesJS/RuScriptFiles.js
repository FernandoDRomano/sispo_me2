...
var RuScriptFiles= `
	...
	var FicheroDeOrigen = "Banco/";// Main Ref -> 
	var NombreFicheroDeOrigen = "Banco";// Main Ref -> 
	var Directorio="files";// Main Ref -> 
			...
			function render(data) {
				...
				if(scannedFiles.length) {
					scannedFiles.forEach(function(f) {
						...
						var file = $('<li class="files"><a href="'+ FicheroDeOrigen + f.path+'" target="_blank" title="'+ f.path +'" class="files" download>'+icon+'<span class="name">'+ name +'</span> <span class="details">'+fileSize+'</span></a></li>');
