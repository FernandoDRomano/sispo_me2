...
function eraseCookie(name) {   
	...
	function Requiered(ElementId,DigitosMinimos,MSJ="Complete El Campo"){
		return Needed(ElementId,DigitosMinimos,MSJ);
	}
	...
	*/
	...
	function ModalOn(e, Modal='myModal', href = '#'){
		var emodal= '#'+Modal;
		$(emodal).removeData("modal");
		document.getElementById(Modal).innerHTML='';
		$(emodal).removeData("modal");
		document.getElementById(Modal).e = e;
		$(emodal).attr("href", href);
		$(emodal).load($(emodal).attr('href'));
		$(emodal).modal('show');
		//console.log(e.DataX);
		//console.log(e.DataY);
	}
